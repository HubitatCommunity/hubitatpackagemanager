 ...
 *
 *
 *    csteele v1.9.12   Added "menu" to definition metadata.
 *				   Added maintained by CSteele to banner.
...
definition(
	...
	category: "My Apps",
	menu: "Apps", // Available options are: "Integrations", "Automations", or "Apps"
...
def displayHeader(def txt = '') {
	section (getFormat("title", "Hubitat Package Manager $txt")) {
		paragraph "<div style='color:#1A77C9;text-align:right;font-weight:small;font-size:9px;'>Developed by: DCMeglio<br/>Maintained by: CSteele<br/>Current Version: ${version()} -  ${thisCopyright}</div>"
